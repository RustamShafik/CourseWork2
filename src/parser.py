...
class HH(Parser):
    ...
    def _connect_to_api(self, keyword):
        ...
        params = {'text': keyword, 'per_page': 20}  # Параметры запроса: ключевое слово и количество вакансий на странице
    ...
    def load_vacancies(self, keyword=""):
        ...
        if data and 'items' in data:  # Проверяем, что ключ 'items' существует в ответе
            return data['items']
        else:
