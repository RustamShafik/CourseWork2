class FileWorker:
    ...
    def _validate_url(self, url):
        '''Проверяет, что ссылка на вакансию является строкой и начинается с "http".'''
        if not isinstance(url, str) or not url.startswith('http'):
            raise ValueError('Ссылка на вакансию должна быть строкой и начинаться с "http".')
        return url

    def _validate_salary(self, salary):
        '''Проверяет, что зарплата является числом и не отрицательной. Если нет, возвращает 0.'''
    ...
    def __lt__(self, other):
        '''Магический метод, возвращающий True, если зарплата текущей вакансии меньше зарплаты другой вакансии.'''
        return self.salary < other.salary

    def __gt__(self, other):
        '''Магический метод, возвращающий True, если зарплата текущей вакансии больше зарплаты другой вакансии.'''
        return self.salary > other.salary

    def __eq__(self, other):
        '''Магический метод, возвращающий True, если зарплата текущей вакансии равна зарплате другой вакансии.'''
        return self.salary == other.salary

    def __le__(self, other):
        '''Магический метод, возвращающий True, если зарплата текущей вакансии меньше или равна зарплате другой вакансии.'''
        return self.salary <= other.salary

    def __ge__(self, other):
        '''Магический метод, возвращающий True, если зарплата текущей вакансии больше или равна зарплате другой вакансии.'''
        return self.salary >= other.salary

    def __str__(self):
        '''Возвращает строковое представление объекта.'''
        return (f"FileWorker(name={self.name}, url={self.url}, "
