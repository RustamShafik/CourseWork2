...
import json
from utils import print_search_query, sort_vacancies_by_top_salary, search_by_query_desc

def interact():
    choice = input("Приветствуем вас!\n"
    ...
    if choice == "1":
        ...
        n = int(input("Укажите, сколько вакансий с максимальной зарплатой вы хотите увидеть: "))
